    ...
    <main className="min-h-screen bg-white text-slate-900">
      <section className="mx-auto max-w-5xl px-6 py-20">
        ...
        <h1 className="mt-4 text-4xl font-bold tracking-tight md:text-6xl">
          About Ayurvigyan Foundation
        </h1>

        <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
          Ayurvigyan Foundation is a medical learning ecosystem built to support
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-slate-200 p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
            ...
            <p className="mt-4 leading-8 text-slate-600">
              Beginning with a flagship book, Ayurvigyan Foundation is growing into a
        ...
        <div className="mt-16 rounded-3xl border border-slate-200 bg-slate-50 p-8 md:p-10">
          ...
          <p className="mt-5 leading-8 text-slate-600">
            Ayurvigyan Foundation exists to bridge the gap between learning medicine
