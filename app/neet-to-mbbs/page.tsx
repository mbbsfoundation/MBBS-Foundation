    ...
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="relative border-b border-slate-100 bg-gradient-to-b from-slate-50/80 via-white to-white px-4 pt-12 pb-16 sm:px-6 sm:pt-16 sm:pb-20 lg:pt-20 lg:pb-24">
        <div className="mx-auto max-w-5xl">
          ...
          {/* Active Round 2 Alert Banner */}
          <div className="mt-8 rounded-2xl border-2 border-blue-300/80 bg-gradient-to-r from-blue-50/90 via-indigo-50/50 to-white p-4 sm:p-5 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <span className="inline-flex items-center gap-1.5 rounded-md bg-blue-600 text-white px-2.5 py-0.5 text-[10px] font-black uppercase tracking-wider">
                  <span className="h-1.5 w-1.5 rounded-full bg-white animate-pulse"></span>
                  MCC Round 2 • NEET UG 2026
                </span>
                <span className="text-xs font-semibold text-slate-500">
                  Active Counselling Phase
                </span>
              </div>
              <h2 className="text-sm sm:text-base font-bold text-slate-900">
                New seats, vacancies and upgrade decisions can change your options.
              </h2>
              <p className="text-xs text-slate-600 max-w-2xl">
                Understand newly added seats, clear vs virtual vacancies, and evaluate whether an upgrade is genuinely right for you.
              </p>
            </div>
